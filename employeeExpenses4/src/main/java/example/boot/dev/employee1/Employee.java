...
public class Employee {
	...
	public void addEnrollmentCourse(EnrollmentCourse enrollmentCourse) {
		...
		enrollmentCourse.setEmployee(this);
	}
	...
	public List<EnrollmentCourse> getEnrollmentCourse() {
		return enrollmentCourses;
	}

	public void setEnrollmentCourse(List<EnrollmentCourse> enrollmentCourses) {
